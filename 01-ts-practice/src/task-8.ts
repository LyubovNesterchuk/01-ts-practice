...
function getPermissions(role: Role): string[] {
  switch (role) {
    ...
    case Role.Guest:
      return ["read"];
    default:
      // Цей блок не обов'язковий, бо TypeScript гарантує, що `role` — це Role
      return [];
  }
}
...
// ✅ Перевірка
const adminPerms = getPermissions(Role.Admin); // OK
const guestPerms = getPermissions(Role.Guest); // OK
